...
export default {
  ...
  mounted() {
    eventbus.$on(this.showEventName, this.showEventListener)
    eventbus.$on(this.hideEventName, this.hideEventListener)
  },
  beforeDestroy() {
    eventbus.$off(this.showEventName, this.showEventListener)
    eventbus.$off(this.hideEventName, this.hideEventListener)
  },
  computed: {
    showEventName() {
    ...
    className() {
      return ['popover', this.pointer && this.positionClass]
    },
    style() {
